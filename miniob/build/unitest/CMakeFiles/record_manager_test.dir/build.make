...
unitest/CMakeFiles/record_manager_test.dir/record_manager_test.cpp.i: cmake_force
	...
	cd /root/miniob/build/unitest && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/miniob/unitest/record_manager_test.cpp > CMakeFiles/record_manager_test.dir/record_manager_test.cpp.i
...
unitest/CMakeFiles/record_manager_test.dir/record_manager_test.cpp.s: cmake_force
	...
	cd /root/miniob/build/unitest && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/miniob/unitest/record_manager_test.cpp -o CMakeFiles/record_manager_test.dir/record_manager_test.cpp.s
...
bin/record_manager_test: unitest/CMakeFiles/record_manager_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/miniob/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/record_manager_test"
	cd /root/miniob/build/unitest && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/record_manager_test.dir/link.txt --verbose=$(VERBOSE)
	cd /root/miniob/build/unitest && /usr/bin/cmake -D TEST_TARGET=record_manager_test -D TEST_EXECUTABLE=/root/miniob/build/bin/record_manager_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/root/miniob/build/unitest -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=record_manager_test_TESTS -D CTEST_FILE=/root/miniob/build/unitest/record_manager_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P /usr/share/cmake/Modules/GoogleTestAddTests.cmake
...
unitest/CMakeFiles/record_manager_test.dir/clean:
	cd /root/miniob/build/unitest && $(CMAKE_COMMAND) -P CMakeFiles/record_manager_test.dir/cmake_clean.cmake
.PHONY : unitest/CMakeFiles/record_manager_test.dir/clean

unitest/CMakeFiles/record_manager_test.dir/depend:
	cd /root/miniob/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/miniob /root/miniob/unitest /root/miniob/build /root/miniob/build/unitest /root/miniob/build/unitest/CMakeFiles/record_manager_test.dir/DependInfo.cmake --color=$(COLOR)
