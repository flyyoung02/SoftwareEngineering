...
|            |                    | DeleteLogicalOperator : public LogicalOperator      | 删除逻辑算子                                                 |
|            |                    | ExplainLogicalOperator : public LogicalOperator     | 描述逻辑算子                                                 |
...
|            |                    | ExplainPhysicalOperator : public PhysicalOperator   | 描述物理算子                                                 |
|            |                    | DeletePhysicalOperator : public PhysicalOperator    | 删除物理算子                                                 |
|            |                    | PredicatePhysicalOperator : public PhysicalOperator |                                                              |
|            |                    |                                                     |                                                              |
|            |                    |                                                     |                                                              |
|            |                    |                                                     |                                                              |
